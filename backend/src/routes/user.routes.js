...
// Units — Admin manages, Guard needs read access to look up hosts for walk-in visitor logging
router.get('/units', protect, authorize('Admin', 'SuperAdmin', 'Guard'), ctrl.listUnits);
